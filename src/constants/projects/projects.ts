...
export const TECHS: ProjectTechs = {
  ...
  gitlab: { name: 'GitLab', icon: icons.gitlab, id: uuidv4() },

  // react: { name: 'React', icon: icons.react, id: uuidv4() },
  angular: { name: 'Angular', icon: icons.angular, id: uuidv4() },
  vuejs: { name: 'VueJs', icon: icons.vuejs, id: uuidv4() },
  // typeScript: { name: 'TypeScript', icon: icons.typeScript, id: uuidv4() },
  // nextjs: { name: 'NextJs', icon: icons.nextjs, id: uuidv4() },
  d3js: { name: 'D3js', icon: icons.d3js, id: uuidv4() },
  gatsby: { name: 'Gatsby', icon: icons.gatsby, id: uuidv4() },
  // javaScript: { name: 'JavaScript', icon: icons.javaScript, id: uuidv4() },
  // tailwind: { name: 'Tailwind', icon: icons.tailwind, id: uuidv4() },
  // sass: { name: 'Sass', icon: icons.sass, id: uuidv4() },
  // css: { name: 'CSS', icon: icons.css, id: uuidv4() },
  // html: { name: 'HTML', icon: icons.html, id: uuidv4() },
  jquery: { name: 'Jquery', icon: icons.jquery, id: uuidv4() },
  // bootstrap: { name: 'Bootstrap', icon: icons.bootstrap, id: uuidv4() },
  // nodejs: { name: 'NodeJs', icon: icons.nodejs, id: uuidv4() },
  laravel: { name: 'Laravel', icon: icons.laravel, id: uuidv4() },
  php: { name: 'PHP', icon: icons.php, id: uuidv4() },
  go: { name: 'GO', icon: icons.go, id: uuidv4() },
  codeigniter: { name: 'Codeigniter', icon: icons.codeigniter, id: uuidv4() },
  graphql: { name: 'GraphSQL', icon: icons.graphql, id: uuidv4() },
  // python: { name: 'Python', icon: icons.python, id: uuidv4() },
  // django: { name: 'Django', icon: icons.django, id: uuidv4() },
  // flask: { name: 'Flask', icon: icons.flask, id: uuidv4() },
  aspnet: { name: 'ASP.Net', icon: icons.aspnet, id: uuidv4() },
  csharp: { name: 'C#', icon: icons.csharp, id: uuidv4() },
  reactnative: { name: 'React Native', icon: icons.reactnative, id: uuidv4() },
  swift: { name: 'Swift', icon: icons.swift, id: uuidv4() },
  ionic: { name: 'Ionic', icon: icons.ionic, id: uuidv4() },
  ios: { name: 'iOS', icon: icons.ios, id: uuidv4() },
  android: { name: 'Android', icon: icons.android, id: uuidv4() },
  // flutter: { name: 'Flutter', icon: icons.flutter, id: uuidv4() },
  // dart: { name: 'Dart', icon: icons.dart, id: uuidv4() },
  // mongodb: { name: 'MongDB', icon: icons.mongodb, id: uuidv4() },
  // sqlite: { name: 'Sqlite', icon: icons.sqlite, id: uuidv4() },
  // firebase: { name: 'Firebase', icon: icons.firebase, id: uuidv4() },
  // mysql: { name: 'MySQL', icon: icons.mysql, id: uuidv4() },
  postgresql: { name: 'PostgreSQL', icon: icons.postgresql, id: uuidv4() },
  algolia: { name: 'Algolia', icon: icons.algolia, id: uuidv4() },
  aws: { name: 'AWS', icon: icons.aws, id: uuidv4() },
  azure: { name: 'Azure', icon: icons.azure, id: uuidv4() },
  microservice: { name: 'Microservice', icon: icons.microservice, id: uuidv4() },
  // git: { name: 'Git', icon: icons.git, id: uuidv4() },
  // gitlab: { name: 'Gitlab', icon: icons.gitlab, id: uuidv4() },
  bitbucket: { name: 'Bitbucket', icon: icons.bitbucket, id: uuidv4() },
  docker: { name: 'Docker', icon: icons.docker, id: uuidv4() },
  jira: { name: 'Jira', icon: icons.jira, id: uuidv4() },
  trello: { name: 'Trello', icon: icons.trello, id: uuidv4() },
  asana: { name: 'Asana', icon: icons.asana, id: uuidv4() },
  monday: { name: 'Monday', icon: icons.monday, id: uuidv4() } 
} as const;
